...
const CreateTransportModal = ({ onClose, transportTypes, onTransportAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("transport_type", transportType ? transportType.value : "");
      ...
      await axios.post(
        Config.getApiUrl("transport", "create_transport"),
  ...
  const handlePelakChange = (field, maxLength) => (e) => {
    ...
    if (/^\d*$/.test(value) && value.length <= maxLength) {
      setPelak((prevPelak) => ({ ...prevPelak, [field]: value }));
    }
  };
            ...
            <div style={{ flex: "0 0 60%" }}>
              ...
              <div className={styles.formGroup}>
                ...
                <div className={styles.licensePlateCard}>
                  ...
                  />
                  <span className={`${styles.licensePlateSegment} ${styles.middle}`}>
                    ع
                  </span>
                  <input
                    type="text"
