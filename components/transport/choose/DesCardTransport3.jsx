...
import styles from './DesCardTransport3.module.css'; // وارد کردن استایل

const DesCardTransport3 = ({ href, coverImage, titleImage, characterImage, color }) => {
...
export default DesCardTransport3;
