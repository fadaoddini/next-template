...
import styles from './DesCardTransport2.module.css'; // وارد کردن استایل

const DesCardTransport2 = ({ href, coverImage, titleImage, characterImage , color }) => {
...
export default DesCardTransport2;
