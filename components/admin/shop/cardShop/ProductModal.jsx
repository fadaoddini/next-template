...
import { formatPrice } from "@/components/utils/FormatPrice/formatPrice";
 

import CountProduct from './CountProduct';

import { AddToCartContext } from '@/components/shop/utils/AddToCartContext';
...
const ProductModal = ({ product, isOpen, onClose }) => {
 ...
 // اگر modal باز نیست، هیچ چیز نمایش نده
  ...
  const handleAddToCart = () => {
    ...
    if (totalCount > product.number_send) {
      ...
      onClose();
 // بستن modal پس از اضافه کردن به سبد خرید
    }
  };
